...
namespace Rock.Blocks.Cms
{
    ...
    public class PageMenu : RockBlockType
    {
        ...
        private void BlockPropertyOverride()
        {
            ...
            {
                if ( block.Role == BlockRole.Secondary )
                {
                    // If the block was previously set to Secondary but IsSecondaryBlock is now false, reset it to DefaultRole
                    block.Role = this.BlockCache.BlockType.DefaultRole;
                }
            }
