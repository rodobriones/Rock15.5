...
using static Rock.Blocks.Mobile.MobileDeepLinkDetail;
...
namespace Rock.Blocks.Cms
{
    ...
    public partial class FileEditor : RockBlockType
    {
        ...
        string _worksurfaceLayoutName = "Full Worksurface";
        ...
        /// <summary>
        /// Initializes and retrieves the state of the Obsidian block, including any error messages if the
        /// initialization fails.
        /// </summary>
        /// <remarks>This method checks whether the current user is authorized and whether the relative
        /// file path is valid.  If either check fails, an error message is returned in the resulting object. Otherwise,
        /// the method  returns the initial state of the block.</remarks>
        /// <returns>A <see cref="CustomBlockBox{TBag, TOptions}"/> object containing the initial state of the block if
        /// successful,  or an error message if the initialization fails.</returns>
        ...
        public BlockActionResult Save( FileEditorBag bag )
        {
            ...
            if ( bag.FileContents.IsNullOrWhiteSpace() )
            {
