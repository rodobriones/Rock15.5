...
| `C:\Repos\Rock18.1\Plugin.VidaRealEvents\README.md` | **Migración consolidada `017_ProductionSetup`** (única del assembly; ejecuta los 17 pasos históricos — producción la corre de un golpe, dev la salta), tabla de pasos, modelo de permisos, deploy. ⚠️ Próxima migración = nº 18+ | Al agregar una migración nueva o desplegar el plugin (leer ANTES de numerar). |
