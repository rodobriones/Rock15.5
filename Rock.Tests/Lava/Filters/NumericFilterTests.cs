...
";
        ...
        */
        ...
        [DataRow( 3, 2, "6" )]
        [DataRow( 3.0, 2.0, "6" )]
        [DataRow( 3.01, 2.01, "6.0501" )]
        public void Times_ValidNumericDoubleOperands_ReturnsNumericResult( double input1, double input2, string expectedResult )
        {
        ...
        [DataTestMethod]
        [DataRow( "3", "2", "6", "de-DE" )]
        [DataRow( "3.0", "2.0", "6.0", "en-US" )] // You might expect this to be 6.00 but it is not (C# preserves the scale (number of decimals) based on the operands' scales.)
