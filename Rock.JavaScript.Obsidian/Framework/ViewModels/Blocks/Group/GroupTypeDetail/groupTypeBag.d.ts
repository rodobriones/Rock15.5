...
import { GroupTypeScheduleExclusionBag } from "@Obsidian/ViewModels/Blocks/Group/GroupTypeDetail/groupTypeScheduleExclusionBag";
...
export type GroupTypeBag = {
    ...
    /**
     * When Rock.Model.GroupType.AttendanceRule is set to Rock.Model.AttendanceRule.AlreadyEnrolledInGroup
     * then this specifies the group matching logic used.
     * 
     * Rock.Enums.CheckIn.AlreadyEnrolledMatchingLogic.MustBeEnrolled simply
     * that the person be a member of the group and no additional filtering
     * is performed.
     * 
     * Rock.Enums.CheckIn.AlreadyEnrolledMatchingLogic.PreferEnrolledGroups will
    ...
    /** Gets or sets the attendance reminder followup days list. This corresponds to Rock.Model.GroupType.AttendanceReminderFollowupDaysList. */
    ...
    scheduleExclusions?: GroupTypeScheduleExclusionBag[] | null;
