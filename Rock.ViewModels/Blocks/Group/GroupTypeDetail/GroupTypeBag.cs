...
namespace Rock.ViewModels.Blocks.Group.GroupTypeDetail
{
    ...
    public class GroupTypeBag : EntityBagBase
    {
        ...
        /// <summary>
        /// When <see cref="Rock.Model.GroupType.AttendanceRule" /> is set to <see cref="Rock.Model.AttendanceRule.AlreadyEnrolledInGroup" />
        /// then this specifies the group matching logic used.
        /// 
        /// 
        /// <see cref="Rock.Enums.CheckIn.AlreadyEnrolledMatchingLogic.MustBeEnrolled" /> simply
        /// that the person be a member of the group and no additional filtering
        /// is performed.
        /// 
        /// 
        /// <see cref="Rock.Enums.CheckIn.AlreadyEnrolledMatchingLogic.PreferEnrolledGroups" /> will
        ...
        /// <summary>
        /// Gets or sets the attendance reminder followup days list. This corresponds to <see cref="Rock.Model.GroupType.AttendanceReminderFollowupDaysList"/>.
        /// </summary>
        ...
        /// </summary>
        public List<GroupTypeScheduleExclusionBag> ScheduleExclusions { get; set; }
