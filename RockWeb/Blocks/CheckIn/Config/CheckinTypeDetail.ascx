            ...
            <div class="panel panel-block">
                ...
                <div class="panel-body">
                    ...
                    <div id="pnlEditDetails" runat="server">
                        ...
                        <div class="actions">
                            <asp:LinkButton ID="btnSave" runat="server" data-shortcut-key="s" ToolTip="Alt+s" Text="Guardar" CssClass="btn btn-primary" OnClick="btnSave_Click" />
                            <asp:LinkButton ID="btnCancel" runat="server" data-shortcut-key="c"  ToolTip="Alt+c" Text="Cancelar" CssClass="btn btn-link" CausesValidation="false" OnClick="btnCancel_Click" />
                        </div>
