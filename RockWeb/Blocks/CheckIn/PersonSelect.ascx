                ...
                <div class="control-group checkin-body-container">
                    ...
                    <div class="controls">
                        <asp:Repeater ID="rSelection" runat="server" OnItemCommand="rSelection_ItemCommand" OnItemDataBound="rSelection_ItemDataBound">
                            <ItemTemplate>
                                <Rock:BootstrapButton ID="lbSelect" runat="server" CommandArgument='<%# Eval("Person.Id") %>' CssClass="btn btn-primary btn-large btn-block btn-checkin-select text-center" DataLoadingText="Cargando..." />
                            </ItemTemplate>
                        </asp:Repeater>
                    </div>
                </div>
