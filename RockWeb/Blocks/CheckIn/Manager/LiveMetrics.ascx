                        ...
                        <ItemTemplate>
                            <li id="liNavItem" runat="server" class="list-group-item cursor-pointer">
                                ...
                                <div class="pull-right d-flex align-items-center">
                                    ...
                                    <Rock:Toggle ID="tglRoom" runat="server" CssClass="ml-3" OnText="Abrir" OffText="Cerrar" ButtonSizeCssClass="btn-xs" OnCssClass="btn-success" OffCssClass="btn-danger" OnCheckedChanged="tglRoom_CheckedChanged"  />
