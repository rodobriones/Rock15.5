...
<head runat="server">
    ...
    <%-- Hace que los CSS de íconos no bloqueen el primer paint (PageSpeed mobile) --%>
    <script>
    (function () {
        var TARGETS = [/tabler-icon\.css/i, /fontawesome-icon\.css/i, /fontawesome-solid\.css/i, /summernote\.min\.css/i];
